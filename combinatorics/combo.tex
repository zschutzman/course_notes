...
%
\newcommand{\coursetitle}{Math 580 - Combinatorics}
\newcommand{\lecturer}{Greta Panova}
\newcommand{\notetaker}{Zach Schutzman}
\newcommand{\notetakersemail}{ianzach+notes@seas.upenn.edu}
\newcommand{\courseterm}{Fall 2016}
\newcommand{\institution}{The University of Pennsylvania}
...
\begin{document}
	...
	Math 318 is one of the nine courses offered for first-year mathematics graduate students at the University of Chicago. It is the second of three courses in the year-long geometry/topology sequence.
	
	These notes are being live-TeXed, though I edit for typos and add diagrams requiring the Ti\textit{k}Z package separately. I am using the editor TeXstudio.
