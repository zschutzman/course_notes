...
%
\newcommand{\coursetitle}{CIS 677 - Complexity, Randomness, and Algebra in Counting and Cryptography}
\newcommand{\lecturer}{Sampath Kannan}
\newcommand{\notetaker}{Zach Schutzman}
\newcommand{\notetakersemail}{ianzach+notes@seas.upenn.edu}
\newcommand{\courseterm}{Spring 2019}
...
\author{Lectures by Prof. \lecturer\\ 
	Notes by \notetaker}
\title{\coursetitle}
...
\newcommand{\classheader}[2]{\stepcounter{lecture}\newpage\section*{Lecture \arabic{lecture}: #2  (#1)}
	\phantomsection \addcontentsline{toc}{section}{Lecture \arabic{lecture}: {#2} (#1)}}
