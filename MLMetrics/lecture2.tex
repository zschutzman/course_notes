...
\definition{The Mallows distribution is a probability distribution that looks like $\frac{1}{Z(\theta)} \exp{-\theta d_K (\sigma,\sigma_0)}$, where $\sigma_0\in S_n$ is the modal permutation, $\theta\geq 0$ is the dispersion parameter.  $Z$ is a normalization function of the parameters.}
